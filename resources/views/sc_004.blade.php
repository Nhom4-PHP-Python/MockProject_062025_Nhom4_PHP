...
@section('title', 'Add Relevant Party')
@section('content')
<div class="container">
...
<style>
    ...
    .step { width: 32px; height: 32px; border-radius: 50%; background: #eee; color: #222; display: flex; align-items: center; justify-content: center; font-weight: bold; font-size: 18px; }
